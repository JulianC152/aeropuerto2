...
<html lang = "es">
	...
	<div id="lista">
		<div id="encaregi">
			...
			<div class="a4">Años Experiencia</div>
			<div class="a5">N_licenca</div>
			<div class="a6">Direccion</div>
			<div class="a7">Nacionalidad</div>
		</div>
		<div id="regi">
			<?php
				include("conectarbd.php");
				$conectarbd = Conectar();
				$Query = "SELECT * FROM piloto order by id_piloto;";
				if ($results = $conectarbd->query($Query))
				{while ($Registro = $results->fetch(PDO::FETCH_ASSOC))
						{
						echo "<ul>";
							echo "<div class='a40'></div>"; //un espacio de 40px
							echo "<div class='a2'>".$Registro['id_piloto']."</div>"; //campo “id_forma” ancho 100px
							echo "<div class='a3'>".$Registro['nombre']."</div>"; //campo “forma” ancho 160px
							echo "<div class='a4'>".$Registro['anos_experiencia']."</div>"; //campo “forma” ancho 160px
							echo "<div class='a5'>".$Registro['n_licencia']."</div>"; //campo “forma” ancho 160px
							echo "<div class='a6'>".$Registro['direccion']."</div>"; //campo “forma” ancho 160px
							echo "<div class='a7'>".$Registro['nacionalidad']."</div>"; //campo “forma” ancho 160px
							echo "<div class='a50'>".'<a href="modipiloto.php?id_piloto='.$Registro['id_piloto'].'"><img
