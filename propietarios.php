...
<html lang = "es">
	...
	<section id = tablap>
		<div id="Titelementos">Lista de Propietarios
			<input type="button" onclick="location.href='menu.php'" value="X">
			<br>
			<div id="Addelemento" onclick="location.href='nuevop.php'">
			 <a href='nuevoprop.php'> Agregar </a>
			<img src="images/propie.ico">
			</div>
		</div>
	</body>
	<div id="lista">
		<div id="encaregi">
			<div class="a40"></div>
			<div class="a1">Id Propietario</div>
			<div class="a3">Nombre</div>
			<div class="a4">Direccion</div>
			<div class="a5">Identificacion</div>
			<div class="a6">Tipo Identificacion</div>
			<div class="a7">Tipo Propietario</div>
		</div>
		<div id="regi">
			<?php
				include("conectarbd.php");
				$conectarbd = Conectar();
				$Query = "SELECT * FROM propietario order by id_propietario;";
				if ($results = $conectarbd->query($Query))
				{while ($Registro = $results->fetch(PDO::FETCH_ASSOC))
						{
						echo "<ul>";
							echo "<div class='a40'></div>"; //un espacio de 40px
							echo "<div class='a2'>".$Registro['id_propietario']."</div>"; //campo “id_forma” ancho 100px
							echo "<div class='a3'>".$Registro['nombre']."</div>"; //campo “forma” ancho 160px
							echo "<div class='a4'>".$Registro['direccion']."</div>"; //campo “forma” ancho 160px
							echo "<div class='a5'>".$Registro['identificacion']."</div>"; //campo “forma” ancho 160px
							echo "<div class='a6'>".$Registro['Tipo_id']."</div>"; //campo “forma” ancho 160px
							echo "<div class='a7'>".$Registro['Tipo_pro']."</div>"; //campo “forma” ancho 160px
							echo "<div class='a50'>".'<a href="modipiloto.php?id_propietario='.$Registro['id_propietario'].'"><img
